...
from interfaces import IExampleDocumentType, IExampleDocumentTypeVersion
from Products.SilvaUCLExampleContentTypes.silvaxmlattribute import SilvaXMLAttribute
...
class ExampleDocumentType(CatalogedVersionedContent):
    """Base class for the ExampleDocumentType type.
    """
    security = ClassSecurityInfo()

    implements(IExampleDocumentType)
    meta_type = 'Example Document'
    __doc__ = """A Example Document is a page type which serves as an example to us all"""
